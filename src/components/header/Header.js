  ...
  <Fragment>
    ...
    <div className="header h-full lg:h-screen lg:w-screen p-6 relative flex justify-between from-primary to-secondary text-primary-content -mt-[4rem] grid 
      ...
      <div className="details flex flex-col w-1/2 w-1/2 h-full  align-center"> 
         ...
         <div className="info h-auto flex rounded-lg shadow-md w-2/3">
          <div className="flex flex-row justify-center align-center">
            <progress className="progress progress-secondary w-96 h-4 m-2" value="80" max="100"/> <span className='leading-2 mt-1'>JavaScript</span>
          </div>
          
          <div className="flex flex-row justify-center align-center">
            <progress className="progress progress-secondary w-96 h-4 m-2" value="85" max="100"/> <span className='leading-2 mt-1'>React JS</span>
          </div>

          <div className="flex flex-row justify-center align-center">
            <progress className="progress progress-secondary w-96 h-4 m-2" value="85" max="100"/> <span className='leading-2 mt-1'>CSS/SASS</span>
          </div>

          <div className="flex flex-row justify-center align-center">
            <progress className="progress progress-secondary w-96 h-4 m-2" value="93" max="100"/> <span className='leading-2 mt-1'>HTML/JSX</span>
          </div>

          <div className="flex flex-row justify-center align-center">
            <progress className="progress progress-secondary w-96 h-4 m-2" value="85" max="100"/> <span className='leading-2 mt-1'>Tailwind</span>
          </div>

          <div className="flex flex-row justify-center align-center">
            <progress className="progress progress-secondary w-96 h-4 m-2" value="65" max="100"/> <span className='leading-2 mt-1'>Redux</span>
          </div>

          <div className="flex flex-row justify-center align-center">
            <progress className="progress progress-secondary w-96 h-4 m-2" value="30" max="100"/> <span className='leading-2 mt-1'>Node JS</span>
          </div>
         </div>
